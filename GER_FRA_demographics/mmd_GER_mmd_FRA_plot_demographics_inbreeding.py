...
def main():
    ...
    split_delay_mig_popt = get_popt('results/FRA_GER_split_delay_mig_inbreeding_demo_fits_combined.txt')
    plot_split_delay_mig_demography(fs, ns, pts_l, split_delay_mig_popt)

    #split_mig_demography
    split_mig_popt = get_popt('results/FRA_GER_split_mig_inbreeding_demo_fits_combined.txt')
