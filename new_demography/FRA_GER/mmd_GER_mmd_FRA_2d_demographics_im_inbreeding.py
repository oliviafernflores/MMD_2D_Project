...
def im_demography(fs, ns, pts):
    ...
    try:
        fid = open(f'demo_results/FRA_GER_im_inbreeding_demo_fits{process_ii}.txt', 'a')
    except:
        fid = open(f'demo_results/FRA_GER_im_inbreeding_demo_fits{process_ii}.txt', 'w')
    for i in range(20):
