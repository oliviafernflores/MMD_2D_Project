...
#     demo_model_ex = dadi.Numerics.make_extrap_func(demo_model)
#     model = demo_model_ex(popt, ns, pts)
#     fig = plt.figure('GER_HEL_Bottlegrowth_Inbreeding_Demography')
#     fig.clear()
#     dadi.Plotting.plot_2d_comp_multinom(model, fs)
#     fig.savefig('plots/GER_HEL_bottlegrowth_inbreeding_demography.png')
...
#     demo_model_ex = dadi.Numerics.make_extrap_func(demo_model)
#     model = demo_model_ex(popt, ns, pts)
#     fig = plt.figure('GER_HEL_Bottlegrowth_Split_Inbreeding_Demography')
#     fig.clear()
#     dadi.Plotting.plot_2d_comp_multinom(model, fs)
#     fig.savefig('plots/GER_HEL_bottlegrowth_split_inbreeding_demography.png')
...
#     demo_model_ex = dadi.Numerics.make_extrap_func(demo_model)
#     model = demo_model_ex(popt, ns, pts)
#     fig = plt.figure('GER_HEL_Bottlegrowth_Split_Migration_Inbreeding_Demography')
#     fig.clear()
#     dadi.Plotting.plot_2d_comp_multinom(model, fs)
#     fig.savefig('plots/GER_HEL_bottlegrowth_split_mig_inbreeding_demography.png')
