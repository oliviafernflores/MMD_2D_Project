...
#SBATCH --job-name="GER_HEL_gamma_DFE"
...
try:
    fid = open('mmd_HEL_mmd_GER_gamma_DFE.txt','a')
except:
    fid = open('mmd_HEL_mmd_GER_gamma_DFE.txt','w')
...
for i in range(1):
    ...
    popt, ll_model = dadi.Inference.opt(p0, data_fs, dfe_func, pts=None, func_args=func_args, lower_bound=lower_bounds, upper_bound=upper_bounds, maxeval=1000, multinom=False, verbose=1)
