...
def main():
    ...
    plot_biv_lognormal_dfe(popt_same_mu_sigma, dfe_func, sele_dist2d, theta_ns, data_fs, 'mmd_IRA_mmd_FRA_biv_lognormal_same_sigma_mu_DFE')
    ...
    plot_biv_lognormal_dfe(popt_same_mu_sigma, dfe_func, sele_dist2d, theta_ns, data_fs, 'mmd_IRA_mmd_FRA_biv_lognormal_different_sigma_mu_DFE')
