...
def split_delay_mig_demography(fs, ns, pts):
    ...
    try:
        fid = open(f'demo_results/GER_HEL_split_delay_mig_inbreeding_demo_fits{process_ii}.txt', 'a')
    except:
        fid = open(f'demo_results/GER_HEL_split_delay_mig_inbreeding_demo_fits{process_ii}.txt', 'w')
    for i in range(20):
