...
def bottlegrowth_split_demography(fs, ns, pts):
    ...
    upper = [10, 10, 1, 3, 1, 1, 1]
    try:
        fid = open(f'demo_results/GER_HEL_bottlegrowth_split_inbreeding_demo_fits{process_ii}.txt', 'a')
    except:
        fid = open(f'demo_results/GER_HEL_bottlegrowth_split_inbreeding_demo_fits{process_ii}.txt', 'w')
    for i in range(20):
